    ...
    <div>
      ...
      <div className='flex flex-col my-10 md:flex-row gap-12  '>
        ...
        <div className=' flex flex-col justify-center gap-6 md:w-2/4 text-sm text-gray-700'>
          ...
          <b className=' text-gray-800 font-bold text-[1.3vw]'>Our Vision</b>
          <p>
...
Our vision at Prescripto is to create a seamless healthcare experience for every user. We aim to bridge the gap between patients and healthcare providers, making it easier for you to access the care you need, when you need it.</p>
      ...
      <div className=' flex flex-col md:flex-row  mb-20 gap-3'>
        <div className=' border  px-10 md:px-16 py-8 flex flex-col gap-8 text-[15px] rounded hover:bg-primary  hover:text-yellow-50 transition-all duration-300 cursor-pointer text-gray-600'>
          <b className=' font-semibold'>Efficiency:</b>
          <p>Streamlined appointment scheduling that fits into your busy lifestyle.</p>
        </div>  
        <div className=' border  px-10 md:px-16 py-8 flex flex-col gap-10 text-[15px] rounded hover:bg-primary  hover:text-yellow-50 transition-all duration-300 cursor-pointer text-gray-600'>
          <b>Convenience:</b>
